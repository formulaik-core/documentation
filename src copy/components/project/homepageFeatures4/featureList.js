...
export default [
  {
    ...
    description: (
      <>
        Formulaik automatically merges the user defined app schema with the features' schema.
      </>
    ),
  },
  {
...

  {
    ...
    description: (
      <>
        Formulaik proposes a rolling deployment using an arbiter so that you don't mistakenly put undesired schema in production. When using this mode, both a /formulaik and a /formulaikstaging endpoints are exposed with separate databases for testing.
      </>
    ),
  },
