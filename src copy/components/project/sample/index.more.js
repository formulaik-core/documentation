  ...
  border-b-0
    ...
    <div class={`          
      ...
      <p className={``}>
        ...
        <CodeBlock language="language-bash">
          {"yarn add @formulaik-community/localable\nyarn add @formulaik-community/countryable"}
        </CodeBlock>
        <CodeBlock language="js">
          {`export default class Creation extends Formulaik.App.Object {
            static features = [
              'localable',          
            ]
          ...
