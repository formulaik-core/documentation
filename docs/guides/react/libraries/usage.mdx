...
For example we will name our folder ```components/formulaik-library```.
...
An input component is standardized, it follows the input interface api](../../../react/reference/input.mdx)
